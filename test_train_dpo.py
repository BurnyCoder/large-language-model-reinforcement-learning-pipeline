"""
Test version of DPO training with minimal configuration.
...
logger.info(f"Starting test DPO training with model={TEST_MODEL}, max_steps={TEST_MAX_STEPS}, dataset_size={TEST_DATASET_SIZE}")
...
print(f"Test DPO model saved to {output_dir}")
